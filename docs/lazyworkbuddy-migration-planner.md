# Lazyworkbuddy Migration Planner
...
The migration planner is a proven methodology extracted from Lazyworkbuddy's own experience
...
`docs/lazyworkbuddy-self-adapter.md`.
...
own creation in v0.10 of the Lazyworkbuddy execution plan.*

# Lazyworkbuddy Loop Protocol v0.7
...
---
_Iteration caps and loop phases trace to `docs/lazyworkbuddy-state-ledger-design.md`. v0.7 adds explicit planning, verification, review, and blocked/rejected terminal paths._

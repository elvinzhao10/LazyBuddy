# Lazyworkbuddy Handoff Protocol
...
VERIFY:
  task: <task id>
  DoneClaim: { ... }
  plan_reference: .lazyworkbuddy/plans/<slug>.md
...
_See `docs/lazyworkbuddy-agent-orchestration.md` for the full flow diagram and `docs/lazyworkbuddy-parallelism-policy.md` for concurrency rules._

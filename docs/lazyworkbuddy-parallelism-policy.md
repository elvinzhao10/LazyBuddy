# Lazyworkbuddy Parallelism Policy

> v0.5 — Rules for concurrent subagent execution in Lazyworkbuddy workflows.
...
| **Context Indexer** | Yes — with explorers | Different dirs; writes to .lazyworkbuddy/context/ |

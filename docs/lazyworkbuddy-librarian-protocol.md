# Lazyworkbuddy Librarian Protocol
...
| New agent created | `docs/lazyworkbuddy-agent-orchestration.md` (agent roster) | Immediate |
| Gap resolved | `docs/lazyworkbuddy-known-gaps.md` | Within same version |
| New gap discovered | `docs/lazyworkbuddy-known-gaps.md` | Within same session |
...
| Version release | `docs/lazyworkbuddy-known-gaps.md` (version section) | Pre-release |
...
| Skill parity check | `docs/lazyworkbuddy-known-gaps.md` (new gaps only) | Per version |

...
The v1.3.0 release was published on GitHub on 2026-09-17. This archived note describes its package behavior; publication does not establish current host readiness.

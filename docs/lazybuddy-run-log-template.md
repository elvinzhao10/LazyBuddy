...
grep -c "Rule" .workbuddy/rules/lazybuddy.md # Rule count check
```
...
_This template is binding. Every version's output must follow it exactly. See `docs/lazybuddy-operating-manual.md` for the workflow that produces this report._

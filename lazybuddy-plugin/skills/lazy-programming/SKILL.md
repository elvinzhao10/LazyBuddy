...
- **Glob/Grep:** File discovery and pattern search use WorkBuddy's Glob and Grep tools instead of earlier host implementation's `codegraph_search`/`lsp_*`.

...
- **Documentation mining:** Read `workbuddy.md`, `.lazybuddy/` run state, plan files, and any design docs referenced in the repository. Cross-reference the change against documented conventions, architecture decisions, and known constraints.

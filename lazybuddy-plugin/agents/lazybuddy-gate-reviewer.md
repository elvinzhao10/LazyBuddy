...
`.lazybuddy/runs/<run_id>/evidence/<goal>/` (all QA artifacts), `.lazybuddy/runs/<run_id>/evidence/<goal>-code-review.md`, `.lazybuddy/plans/<plan>.md` (goal, criteria, adversarial classes), `.lazybuddy/runs/<run_id>/events.jsonl`, `git diff` against base.

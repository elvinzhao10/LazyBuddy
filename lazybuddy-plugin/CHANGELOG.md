...
- Updated release metadata, execution isolation, and outcome evaluation. See root RELEASE_NOTES.md for the published release scope and host-readiness limits.

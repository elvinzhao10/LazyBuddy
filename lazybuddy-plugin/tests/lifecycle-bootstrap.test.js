...
function writeFixtureFiles(root, selfTest = "process.stdout.write('self-test-ok\\n');\n") {
  ...
  fs.writeFileSync(path.join(packageRoot, '.codebuddy-plugin', 'plugin.json'), '{"name":"lazybuddy","version":"1.3.1"}\n');
  fs.writeFileSync(path.join(packageRoot, '.workbuddy-plugin', 'plugin.json'), '{"name":"lazybuddy","version":"1.3.1"}\n');
...
test('parses only canonical official HTTPS source forms for the selected product', () => {
  const accepted = [
    ['https://github.com/elvinzhao10/LazyBuddy', 'v1.3.1'],
    ['https://github.com/elvinzhao10/LazyBuddy.git', 'v1.3.1'],
    ['https://github.com/elvinzhao10/LazyBuddy/tree/release/v1.3.1', 'release/v1.3.1'],
  ];
  const rejected = [
    'http://github.com/elvinzhao10/LazyBuddy',
    'https://github.com/elvinzhao10/LazyBuddy/',
    'https://github.com/elvinzhao10/LazyBuddy?ref=v1.3.1',
...
test('repo, tag, branch, and full-SHA sources resolve through Git to the same immutable commit', () => {
  const sources = [
    'https://github.com/elvinzhao10/LazyBuddy',
    'https://github.com/elvinzhao10/LazyBuddy/tree/v1.3.1',
    'https://github.com/elvinzhao10/LazyBuddy/tree/main',
  ];

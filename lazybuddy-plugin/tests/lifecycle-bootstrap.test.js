...
function writeFixtureFiles(root, selfTest = "process.stdout.write('self-test-ok\\n');\n") {
  ...
  fs.writeFileSync(path.join(packageRoot, '.codebuddy-plugin', 'plugin.json'), '{"name":"lazybuddy","version":"1.1.0"}\n');
  fs.writeFileSync(path.join(packageRoot, '.workbuddy-plugin', 'plugin.json'), '{"name":"lazybuddy","version":"1.1.0"}\n');
...
test('parses only canonical official HTTPS source forms for the selected product', () => {
  const accepted = [
    ['https://github.com/elvinzhao10/LazyBuddy', 'v1.1.0'],
    ['https://github.com/elvinzhao10/LazyBuddy.git', 'v1.1.0'],
    ['https://github.com/elvinzhao10/LazyBuddy/tree/release/v1.1.0', 'release/v1.1.0'],
  ];
  const rejected = [
    'http://github.com/elvinzhao10/LazyBuddy',
    'https://github.com/elvinzhao10/LazyBuddy/',
    'https://github.com/elvinzhao10/LazyBuddy?ref=v1.1.0',
...
test('repo, tag, branch, and full-SHA sources resolve through Git to the same immutable commit', () => {
  const sources = [
    'https://github.com/elvinzhao10/LazyBuddy',
    'https://github.com/elvinzhao10/LazyBuddy/tree/v1.1.0',
    'https://github.com/elvinzhao10/LazyBuddy/tree/main',
  ];

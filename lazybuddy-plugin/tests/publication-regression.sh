...
copy_publication_fixture() {
    ...
    mkdir -p "$fixture_root/lazybuddy-plugin/docs"
    cp "$REPOSITORY_ROOT/lazybuddy-plugin/docs/model-routing.md" "$fixture_root/lazybuddy-plugin/docs/model-routing.md"
    ...
    cp "$REPOSITORY_ROOT/lazybuddy-plugin/contracts/OUTCOME-EVALUATION.md" \
        "$fixture_root/lazybuddy-plugin/contracts/OUTCOME-EVALUATION.md"
}

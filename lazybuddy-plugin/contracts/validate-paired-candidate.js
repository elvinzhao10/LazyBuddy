...
function validateCandidate(candidate, options) {
  ...
  refuse(candidate.release_version !== '1.2.3', 'CANDIDATE_SCHEMA', 'release version');
  ...
  refuse(candidate.onboarding_sibling !== 'live-test-v1.2.3-<combined-digest>-onboarding', 'CANDIDATE_SCHEMA', 'onboarding sibling');

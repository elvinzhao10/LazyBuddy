---
name: init-deep
description: "PLACEHOLDER — init-deep skill. Implemented in v0.4+ (Skills and command workflows)."
---
...
This Skill will be adapted from `reference/lazycodex/plugins/omo/skills/init-deep/SKILL.md`.

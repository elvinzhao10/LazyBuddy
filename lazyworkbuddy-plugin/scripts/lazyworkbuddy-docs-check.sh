#!/bin/bash
# lazyworkbuddy-docs-check.sh — Broken internal markdown link checker (v0.9)
#
# Scans all .md files in docs/ and lazyworkbuddy-plugin/ directories for internal
...
# Scan markdown files in both docs/ and lazyworkbuddy-plugin/

---
description: "Create a decision-complete work plan. Prometheus planner mode — explores, researches, writes a plan to .lazyworkbuddy/plans/. Never writes product code. Produces plans consumed by /lazy-start-work."
---
